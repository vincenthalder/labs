...
```{r}
# YOUR CODE HERE
ggplot(penguins, aes(x = body_mass_g, fill = "red", color = species )) +
  geom_histogram() + 
  theme_minimal()
...
```{r}
# YOUR CODE HERE
ggplot(penguins, aes(x = penguins$body_mass_g, y = penguins$species)) +
  geom_boxplot() +
  geom_jitter(alpha = 0.2, color = "blue") +
...
## --> Change to non-scientific notation with scale_x_continuous() 
```
